package com.example.a28256.comment.adapter;
...
import com.example.a28256.comment.R;
...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            ...
            convertView.setTag(groupHolder);//groupHolder存到convertView
        }else {
            groupHolder = (GroupHolder) convertView.getTag();
        }
        Glide.with(context).load(R.drawable.user_other)//加载图片
                .diskCacheStrategy(DiskCacheStrategy.RESULT)//设置磁盘级别
                .error(R.mipmap.ic_launcher)//加载错误时的图片
                .centerCrop()
                .into(groupHolder.logo);//加载位置
